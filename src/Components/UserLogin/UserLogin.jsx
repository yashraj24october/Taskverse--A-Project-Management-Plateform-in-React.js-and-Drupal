...
const UserLogin = () => {
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Unlock Productivity with TaskVerse</h1>
        <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">At TaskVerse, we empower teams by providing seamless task management, issue tracking, and project documentation. Our platform helps you streamline workflows, collaborate efficiently, and drive success.</p>
